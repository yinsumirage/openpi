...
- Low-memory LoRA new-data validation config: `pi05_arx_lora_new_debug`
...
- New block-stack dataset repo id: `local/arx_block_stack_bimanual_new`
...
- `src/openpi/training/config.py`
  ...
  - Adds `pi05_arx_debug`, `pi05_arx_lora_debug`, `pi05_arx_lora_new_debug`, and `pi05_arx_lora_watermelon_basket_debug`.
  - Use `pi05_arx_lora_debug` as the default training path on 2x RTX 4090.
  - Use `pi05_arx_lora_new_debug` for the newly collected block-stack dataset validation run.
